...
public class dotPlot extends PApplet {
...
public void slider (float theCoolor){
...
class Display {
  ...
  private void displayBestGlyphs( ArrayList<Glyph> bestGlyphs ){
    ...
    s.play( bestGlyphs.get( bestGlyphs.size()-1 ).score, 0.5f );
  }
  ...
  private ArrayList<Color> initPalette (){
    try {
      ...
      for ( String s : lines ){
        ...
        int c = color ( 255*Float.parseFloat(component[0]), 255*Float.parseFloat(component[1]), 255*Float.parseFloat(component[2]) );
...
class Glyph {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "dotPlot" };
    if (passedArgs != null) {
